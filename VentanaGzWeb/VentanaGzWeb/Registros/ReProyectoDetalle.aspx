    ...
    <table style="width:100%;">
        <tr>
            <td class="text-center" style="height: 97px; font-family:Forte"> &nbsp; <asp:Image ID="ProductoImagen" runat="server" Height="138px" ImageUrl='~/Imagenes/gear-icon.png' Width="168px" />
                <strong>
                <h1 style="color: #000066">Registro Proyecto</h1></strong></td> 
        </tr>
        <tr>
            <td class="text-center">Proyecto Id
                &nbsp;<asp:TextBox ID="BuscarIdTextBox" runat="server"></asp:TextBox>
                &nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="BuscarClienteTextBox" ErrorMessage="Campo Cliente Vacio" ForeColor="#CC0000" style="font-size: x-large" ValidationGroup="vgPro">*</asp:RequiredFieldValidator>
        ...
        <tr>
            <td>
                <table style="width: 100%; height: 172px;">
                    <tr>
                        <td class="text-center" style="height: 72px"> Cliente Id <asp:TextBox ID="BuscarClienteTextBox" runat="server" ValidationGroup="vg" Width="149px"></asp:TextBox>
&nbsp;&nbsp;<asp:Button ID="BuscarClienteButton" CssClass="btn btn-primary" runat="server" Text="Buscar" Width="91px" OnClick="BuscarClienteButton_Click" ValidationGroup="vgc" />
                    ...
                    <tr>
                        <td class="text-center" style="height: 62px">Cliente&nbsp;
                            ...
                            &nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="AnchoTextBox" ErrorMessage="Campo Ancho Vacio" ForeColor="#CC0000" style="font-size: x-large" ValidationGroup="vgD">*</asp:RequiredFieldValidator>
                            &nbsp;&nbsp;&nbsp;&nbsp; Fecha&nbsp;
...
&nbsp;&nbsp;Ancho&nbsp;
                            ...
                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="AnchoTextBox" ErrorMessage="Campo Ancho Vacio" ForeColor="#CC0000" style="font-size: x-large" ValidationGroup="vgD">*</asp:RequiredFieldValidator>
                            &nbsp; Atura&nbsp;
                            <asp:TextBox ID="AlturaTextBox" runat="server" Width="68px"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="AlturaTextBox" ErrorMessage="Campo Altura Vacio" ForeColor="#CC0000" style="font-size: x-large" ValidationGroup="vgD">*</asp:RequiredFieldValidator>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="AgregarButton" runat="server" Text="Agregar" Width="113px" OnClick="AgregarButton_Click" ValidationGroup="vgD" />
                        </td>
                    </tr>
                    <tr>
